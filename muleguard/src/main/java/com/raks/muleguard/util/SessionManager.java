...
/**
 * Session manager for MuleGuard to handle session lifecycle and cleanup.
 * 
 * Features:
...
public class SessionManager {
    ...
    /**
     * Clean up all sessions in the muleguard-sessions directory.
    ...
    public static void cleanupAllSessions(String baseTempDir) {
        try {
            Path sessionsDir = Paths.get(baseTempDir, "muleguard-sessions");
