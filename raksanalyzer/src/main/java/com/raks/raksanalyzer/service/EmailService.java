...
/**
 * Service for sending analysis documents via email.
 */
public class EmailService {
    ...
    /**
     * Send analysis documents via email as a ZIP attachment.
     * 
     * @param toEmail Recipient email address
     * @param projectName Project name for email subject
     * @param documentPaths List of document file paths to attach
    ...
    public boolean sendDocuments(String toEmail, String projectName, List<String> documentPaths) {
        ...
        try {
            ...
            // Clean up only the ZIP file (documents remain for user to view/download)
