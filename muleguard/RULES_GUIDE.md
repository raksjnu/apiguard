# MuleGuard Rules Guide

This guide details the validation rules enforced by MuleGuard. Rules are divided into **Code Rules** (000-099) for application source code and **Config Rules** (100-199) for environment properties and directives.
