...
import com.raks.muleguard.MuleGuardMain.RootWrapper;
import com.raks.muleguard.MuleGuardMain.ConfigSection;
    ...
    public static void main(String[] args) {
        try {
            ...
            for (Rule r : sortedRules) {
                ...
                if (r.getChecks() != null) {
                    for (com.raks.muleguard.model.Check c : r.getChecks()) {
            ...
            output = output.replaceAll("!!com.raks.muleguard.MuleGuardMain\\$ConfigSection", "");
            ...
            System.out.println("Perfected rules (full list) written to src/main/resources/rules/rules.yaml");
