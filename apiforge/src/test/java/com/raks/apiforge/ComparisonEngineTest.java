...
public class ComparisonEngineTest {
    ...
    void testCompare_RestMatch() {
        ...
        result.setApi1(api1);
        result.setApi2(api2);
        ComparisonEngine.compare(result, "REST", null, false, false);
    ...
    void testCompare_SoapMatch() {
        ...
        result.setApi1(api1);
        result.setApi2(api2);
        ComparisonEngine.compare(result, "SOAP", null, false, false);
        assertEquals(ComparisonResult.Status.MATCH.name(), result.getStatus());
    }
    @Test
    ...
    void testCompare_RestWithIgnoredFields() {
        ...
        ComparisonEngine.compare(result, "REST", ignored, false, false);
        assertEquals(ComparisonResult.Status.MATCH.name(), result.getStatus());
    }
}
