...
$yamlPath = "C:\raks\apiguard\muleguard\src\main\resources\rules\rules.yaml"
$jsPath = "C:\raks\apiguard\muleguard\rules_data.js"
...
# However, MuleGuard is a Java app. Let's write a quick Java class that uses snakeyaml (which is already in the project dependencies) to do this.
